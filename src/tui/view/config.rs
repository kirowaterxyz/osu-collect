...
fn render_form(frame: &mut Frame, area: Rect, form: &ConfigTab) {
    ...
    let focused_index = match form.focus {
        ...
        ConfigField::DownloadNoVideo => 7,
        ConfigField::DownloadVerifyZipEocd => 8,
        ConfigField::MirrorOsuDirect => 11,
        ConfigField::MirrorNerinyan => 12,
        ConfigField::MirrorSayobot => 13,
        ConfigField::MirrorNekoha => 14,
        ConfigField::MirrorCustomUrl => 15,
